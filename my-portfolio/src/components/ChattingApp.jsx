  ...
  return(
    <div>
      ...
      <button className="projectholder" >
        ...
        <div className="projectimageholder"><img className="projectImg" src="https://cdn.discordapp.com/attachments/710881503592185867/1142534679006814318/ezgif.com-video-to-gif_1.gif" alt="yeah"></img></div>
